...
## Fachlogik
* Nutze `docs/battlescribe-data-format.md` als kanonische Referenz zum Battlescribe-Format (inkl. gesammelter Domänen-Erkenntnisse). Neu gewonnenes Wissen trägst du selbständig dort ein.
