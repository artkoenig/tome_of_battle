...
## Acceptance Criteria
- [ ] 1. Build-Time-Verarbeitung filtert, übersetzt und speichert Commits/Tags in `changelog.json`.
- [ ] 2. Client-Laufzeit ermittelt installierten Commit und filtert die Commit-Liste des Diffs.
- [ ] 3. PWA-Update-Dialog stellt die gefilterten Änderungen unter der Überschrift "Chronik der Veränderungen" dar.
- [ ] 4. Fallback-Logik zeigt die neuesten 50 Commits und einen Hinweis an, falls der installierte Commit nicht in der Historie ist oder das Diff > 50 Commits beträgt.
- [ ] 5. Unit-Tests verifizieren sowohl die Build-Time-Erstellung als auch die Client-seitige Darstellung und Filterung.
