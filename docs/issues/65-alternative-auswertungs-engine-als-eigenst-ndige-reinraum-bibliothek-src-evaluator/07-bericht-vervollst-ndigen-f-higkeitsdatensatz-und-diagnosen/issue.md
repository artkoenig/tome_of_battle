...
## Acceptance Criteria
- [x] Jeder auswählbare Slot weist effektives min/max, Stand, Restspielraum und
      Pflicht-/Gesperrt-/Versteckt-Flag aus, konsistent zu den ausgewerteten Grenzen.
- [x] Ein Slot an seinem Max wird als gesperrt gemeldet; ein Slot unter seinem Min
      als Pflicht-unerfüllt; ein versteckter Slot als versteckt.
- [x] Von Modifikatoren erzeugte bedingte Hinweise erscheinen am betreffenden Slot.
- [x] Die UI-Projektions-Lookups leiten sich rein aus dem Bericht ab und werten
      keine Regel erneut aus.
- [x] Alle bei der Auswertung ausgelösten Diagnosen sind im Bericht enthalten.
