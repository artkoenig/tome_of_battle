...
## Acceptance Criteria
- [x] Ein Modifikator, dessen Bedingungen halten, ändert den anvisierten effektiven
...
- [x] Modifikatoren auf dasselbe Ziel wirken strikt in Dokumentreihenfolge, und die
      Reihenfolge ist am Ergebnis beobachtbar.
- [x] Eine Wiederholung multipliziert die Modifikator-Wirkung mit der ganzzahligen
      Wiederholungszahl; Wiederholungszahl 0 lässt den Modifikator inaktiv.
- [x] Die Zählung stützt sich auf **effektive** Kategorien (nach kategorie-ändernden
      Modifikatoren), nicht auf Basis-Kategorien.
- [x] Eine erneute Modifikator-Anwendung von den Basiswerten aus liefert dieselben
