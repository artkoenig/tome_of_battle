...
## Comments
- Umgesetzt im Metis-Probelauf auf Branch `resolver-immutability`; Ablauf, Entscheidungen und Review-Runden stehen in `docs/issues/080-resolver-immutability.md`. Entschieden wurde gegen Seitentabellen und fuer erzwungene Unveraenderlichkeit nach der Aufbereitung (tiefes Einfrieren des aufgeloesten Graphen).
