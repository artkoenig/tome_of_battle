...
- Hinweis: stripHypotheticalCount wurde im Zuge von 58-i18n durch stripCurrentCountClause in src/i18n/formatValidationError.js ersetzt (Option omitCurrentCount); Verhalten unverändert.
