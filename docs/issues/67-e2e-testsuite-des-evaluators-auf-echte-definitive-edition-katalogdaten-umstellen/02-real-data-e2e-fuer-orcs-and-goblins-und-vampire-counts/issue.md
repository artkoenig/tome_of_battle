...
zusammen mit derselben Spielsystemdatei **und** der gemeinsamen Mercenaries-`.cat`
(auch diese beiden Armee-Kataloge deklarieren den `catalogueLink` auf
Mercenaries). Damit ist belegt, dass die Auflösung nicht auf einen Katalog
zugeschnitten ist, sondern katalogübergreifend trägt.
...
- [ ] Die echten Vampire-Counts-Daten werden ebenso (mit `.gst` + Mercenaries)
      ...
      geprüft.
- [ ] Für beide Kataloge werden per Verweis importierte Definitionen (auch
