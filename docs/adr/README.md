...
| 0003 | [Battlescribe Domain Rules](0003-battlescribe-domain-rules.md) | Accepted | 2026-07-03 |
| 0004 | [Styling Conventions](0004-styling-conventions.md) | Accepted | 2026-07-05 |
...
| 0015 | [React Context für die whfb6-Verlinkungs-Einstellung](0015-settings-context-fuer-whfb6-verlinkung.md) | Superseded by 0023 | 2026-07-19 |
...
| 0022 | [Internationalisierung der UI-Chrome via react-i18next, Content bleibt außen vor](0022-i18n-ui-chrome-react-i18next.md) | Accepted | 2026-07-19 |
| 0023 | [Revision von ADR-0015 — SettingsContext wird generischer Mehr-Werte-Store](0023-settingscontext-generischer-store.md) | Accepted | 2026-07-19 |
