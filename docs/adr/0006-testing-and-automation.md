...
- **Testkatalog der Evaluator-E2E-Tests:** Die End-to-End-Tests der Reinraum-Engine (`src/evaluator/`) sind fachlich, in nicht-technischer Sprache, unter [`docs/testkatalog-evaluator-e2e.md`](../testkatalog-evaluator-e2e.md) katalogisiert. Verbindliche, **von Hand** gepflegte Regel (kein Generator, kein CI-Gate): Wird ein Engine-Problem erkannt und behoben, entstehen im selben Schritt ein E2E-Test **und** ein zugehöriger Katalog-Eintrag; der Katalog bleibt so deckungsgleich mit der Suite.
