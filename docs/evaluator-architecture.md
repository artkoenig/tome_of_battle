<!--
Referenz-Entwurf für die eigenständige Auswertungs-Engine unter `src/contexts/ruleengine/engine/`.
...
record InstanceNode { defId: Id, count: number, catalogueId: Id?, children: InstanceNode[] }
                      ...
                      // Begründung: JSDoc `@param roster` an `evaluate` (src/contexts/ruleengine/evaluator.js)
