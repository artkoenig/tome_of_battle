...
§7.5, §7.6 und der [Kasten `scope="unit"`](../../battlescribe-data-format.md#scope-unit-ancestor)
...
angewendet wird ([§7.7](../../battlescribe-data-format.md#repeat--modifier-mehrfach-anwenden)).
...
eingeschlossen** ([Kasten `scope="unit"`](../../battlescribe-data-format.md#scope-unit-ancestor)).
...
- **`field="ecfa-8486-4f6c-c249"`** ist die **pts-Kostenart** der `.gst`
  ([§5.3](../../battlescribe-data-format.md#53-cost-types-kostenarten)) — der
