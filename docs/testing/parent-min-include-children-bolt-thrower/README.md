...
| **PMICB-R8** | Beide Grenzen behalten ihren **geschriebenen** Wert — im gesamten Fixture-Datensatz adressiert **kein** `modifier` die Ids `41ec-bee5-0865-0448` oder `ccf9-fefc-71c8-bd73`. Dasselbe gilt für alle übrigen hier behaupteten Ids (`aa66…`, `d242…`, `56a0…`, `bf18…`, `d779…`, `f7bb…`, `bdc0…`, `07a8…`, `6652…`, `6f1a…`). | Verifiziert über alle Dateien in `src/evaluator/__fixtures__/whfb6-definitive/`: jede dieser Ids kommt ausschließlich als `constraint id` vor, nie als `modifier field`. |
