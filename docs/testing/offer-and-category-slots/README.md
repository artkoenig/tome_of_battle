...
- **Pflicht ist kein Angebot.** Traegt eine Definition eine `min`-Grenze mit
  ...
  **berichtspflichtig**: seine unerfuellte `min`-Grenze feuert als ganz normale
  Verletzung mit `actual: 0`. Wegen der Duplikat-Regel bekommt eine solche
  Definition im selben Rahmen **nie** zusaetzlich einen Angebots-Anker. Kurz: das
  Angebot ist, was man nehmen *darf*; der Pflicht-Anker ist, was man nehmen *muss*.
