...
des **upstream**-Fixture-Satzes `src/__fixtures__/whfb6/` abgeleitet, dazu aus
...
> `src/__fixtures__/whfb6/`. Der Definitive-Edition-Satz
> (`src/evaluator/__fixtures__/whfb6-definitive/`) enthält dieselben Ids teils mit
