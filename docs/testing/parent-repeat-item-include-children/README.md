...
- **Die Sammelgruppe darüber:** „Arcane Items (OK-AB + Common)"
  ...
  **Link**-Ids der Common-Gruppe nennen (`f969-0b28-b1cf-bb02` = Power Stone,
  ...
  Frage der Link/Ziel-Auflösung ([§9.7, Fallstrick 1](../../battlescribe/patterns/common-patterns.md#97-mehrfach-erlaubte-gegenstände-in-einer-max1-gruppe-dispel-scroll-etc))
