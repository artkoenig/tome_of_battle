...
Necrach — eine Mounts-Gruppe mit `max`-Grenzen.
...
| **Der wortgleiche Zwilling am Vampire Count** `6822-0110-a7c9-cbb0` (`:1921-1951`, `infoLink` `a106-4a05-36ea-cb01` → Profil `fabd-ef67-72f5-6b3f`) und am Vampire Thrall | Identisch gebaut und mit identischer Datenlage — als Beleg oben aufgeführt, aber nicht als eigenes Roster: brächte keinen neuen Fall, nur Wiederholung. |
