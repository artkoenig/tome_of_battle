...
- **`field="b690-4bc0-bb73-267b"`** ist der `characteristicType` **S** des
  ...
  ([§5.4](../../battlescribe-data-format.md#54-profile-types--characteristic-types)) —
...
- **`scope="1d77-9e6e-a6ab-573f"`** ist **kein** Schlüsselwort. Die Spezifikation
  ...
  primary-catalogue` auf ([§7.6](../../battlescribe-data-format.md#76-constraint))
...
| **AIISC-R9** | **Die Ritterzahl ist nach unten auf 5 gebunden, nach oben unbegrenzt;** jedes Regiment führt deshalb genau 5 Modelle, ohne dass eine Grenze feuert. | `selectionEntry "Knight"` `7b8d-8405-0e74-9f46` (`.cat:2029`) → `24bb-871e-6aa3-e4b5` (`min 5 scope="parent" shared="false"`, `.cat:2031`) und `9941-5a64-0bde-add3` (`max -1`, `.cat:2032`; `-1` = unbegrenzt, [§7.6](../../battlescribe-data-format.md#76-constraint) Sentinel-Kasten — der einzige `set 25` hängt an „Border Patrols rules" `4e15-0353-165f-5528`, die in keinem Roster steht). |
