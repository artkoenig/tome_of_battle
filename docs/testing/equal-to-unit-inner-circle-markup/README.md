...
§7.5, §7.6, §8 und der
[Kasten `scope="unit"`](../../battlescribe-data-format.md#scope-unit-ancestor)
...
- **`field="ecfa-8486-4f6c-c249"`** ist die **pts**-Kostenart der `.gst`
  ([§5.3](../../battlescribe-data-format.md#53-cost-types-kostenarten)) — beide
...
- **Basis der Rechnung ist 0 pts:** der `entryLink` setzt ausdrücklich
  ...
  [§9.3](../../battlescribe-data-format.md#93-kosten-am-link-statt-an-der-definition)).
