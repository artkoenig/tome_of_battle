...
| **BSB-R5** | Der Träger darf **eine** Magische Standarte führen. | Der BSB-`entryLink` bringt geschachtelt die Gruppe **„Magical Standard"** (`0406-bb04-6134-2ee9`) mit `constraint max=1 scope=parent`. |
