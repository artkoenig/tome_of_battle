...
angewendet ([§7.7](../../battlescribe-data-format.md#repeat--modifier-mehrfach-anwenden)).
...
| **RRCC-R8** | Der `set -1` auf dieselbe Grenze (= „unbegrenzt", [§7.6, Sentinel-Kasten](../../battlescribe-data-format.md#76-constraint)) ist in **allen** Rostern inert: er ist auf das Kontingent „Grimgor's 'Ardboyz (SoC)" `1821-fbd1-0d96-2d88` gegatet, die Roster nutzen „Standard (OG-AB)". | `:6373-6377` — `modifier type="set" value="-1" field="938b-15b1-f433-e0d5"` mit `condition type="instanceOf" scope="force" childId="1821-fbd1-0d96-2d88"`; `forceEntry` `:147`. |
