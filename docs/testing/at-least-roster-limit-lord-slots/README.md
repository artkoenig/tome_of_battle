...
[§5.6](../../battlescribe-data-format.md#56-force-entries-detachments) warnt
...
| **ARLS-R11** | **Das Budget wird nie überschritten.** Ein Lord kostet 110 pts (`.cat` Z. 240); Knights Vow (`.cat` Z. 3465), Hand Weapon (`.gst` Z. 1041) und Heavy Armour (`.gst` Z. 946) je 0 pts; das Warhorse 21 pts am Verweis (`.cat` Z. 131) bzw. 14 pts an der Definition (`.cat` Z. 3493) — höchstens **131** pts je Lord. Kleinstes Budget ist 999, größte Summe 262 bei Budget 2999. Die roster-weite Budget-Regel steht deshalb überall in `absent`. | Kostenregel [§7.2](../../battlescribe-data-format.md#72-entry-link-info-link-category-link) (*„die Kosten liegen am Link, nicht an der Definition"*); die Aussage hält unter beiden Lesarten. |
...
| Grenze wegen **verborgener** Lord-Kategorie unterdrückt (Budget < 2000) | Roster 01–03 — die Max-Grenze muss trotz `hidden` melden ([§8](../../battlescribe-data-format.md#8-kategorien--sichtbarkeit)). |
