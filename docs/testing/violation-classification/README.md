...
| „Manbiters" (Autor-Meldung + `max 0`; seit Issue 0159 in diesem Kontingent kein Anker mehr) | `0efb-7f63-7932-0655` — `30f0-d417-2185-bf4a` | Mercenaries-`.cat` → `<sharedSelectionEntries>` |
