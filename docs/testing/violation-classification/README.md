...
| 07 | Versteckter Pflicht-Anker schweigt, Angebots-Anker schweigt | Kontingent „Clan Blood Dragons" nur mit den beiden „Allow"-Schaltern. | **VCC-R10:** Der effektiv versteckte Pflicht-Anker „Army of Sylvania" erzeugt **keine** Meldung aus seinen beiden unerfuellten Min-Grenzen (`1f2f…`, `e23f…` je **null**mal; Issue 0088). **VCC-R11:** Der Angebots-Anker „Manbiters" traegt seine Autor-Meldung im Faehigkeits-Datensatz, aber die Meldungsliste enthaelt **weder** diese Autor-Meldung **noch** eine Grenze aus dem Angebot (`30f0…`, `98c2…` je **null**mal). | [`07-phantom-and-offer.ros`](rosters/07-phantom-and-offer.ros) |
