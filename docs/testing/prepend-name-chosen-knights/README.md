...
(§7.7, §8) und aus der vendorten [`Catalogue.xsd`](../../../src/parser/schema/Catalogue.xsd)
...
| XSD-Beleg für die vendorten Konstrukte | `src/parser/schema/Catalogue.xsd` Z. 492 (`join`) und Z. 518 (`prepend`) |
