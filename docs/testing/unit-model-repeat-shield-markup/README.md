...
§7.6 und der [Kasten `scope="unit"`](../../battlescribe-data-format.md#scope-unit-ancestor)
...
| **UMR-R3** | **Ohne den Träger kein Aufschlag.** Ist der Shield nicht gewählt, entfällt der Modifikator vollständig — die Einheit kostet nur ihre Modelle. | Der Modifikator hängt am `entryLink` selbst; ohne Shield-Auswahl gibt es keine Kostenzeile, auf die er wirkte ([§7.2](../../battlescribe-data-format.md#72-entry-link-info-link-category-link): Kosten liegen am Link/Ziel der Auswahl). |
