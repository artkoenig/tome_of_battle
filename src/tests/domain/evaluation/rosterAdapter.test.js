...
// ── App-Roster-Bausteine (Shape aus src/shared/rostermodel/types.js) ───────────────────────────

/** Eine App-Selection mit allen Pflichtfeldern aus `src/shared/rostermodel/types.js`. */
...
/** Eine App-Force mit allen Pflichtfeldern aus `src/shared/rostermodel/types.js`. */
function appForce({ id, forceEntryId, catalogueId = 'cat-main', selections = [] }) {
  return { id, forceEntryId, catalogueId, selections };
}

/** Ein vollstaendiges App-Roster mit allen Pflichtfeldern aus `src/shared/rostermodel/types.js`. */
function appRoster({
  costLimit = 1500,
