...
import { evaluate, prepareDataset, MeasuredPhase } from '../../../domain/evaluator/evaluator.js';
...
vi.mock('../../../domain/evaluator/evalTree.js', async importOriginal => {
...
vi.mock('../../../domain/evaluator/fixpoint.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../domain/evaluator/countIndex.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
    buildIndex(...args) {
...
vi.mock('../../../domain/evaluator/offer.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../domain/evaluator/effectiveState.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../domain/evaluator/constraints.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../domain/evaluator/budget.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../domain/evaluator/report.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
    buildReport(...args) {
