...
import { ConditionKind, ConditionGroupKind, ModifierKind, ModifierTargetKind } from '../../../domain/evaluator/model.js';
import { COMPARATORS, CONDITION_GROUP_COMBINATORS, MODIFIER_HANDLERS } from '../../../domain/evaluator/modifiers.js';
