...
import { evaluate as evaluateDataset } from '../../../domain/evaluator/evaluator.js';
...
import { createNamedRuleRegistry } from '../../../domain/evaluator/infoProjection.js';
...
describe('der Regel-Rueckfall am eingefrorenen Korpus', () => {
  // __fixtures__ bleibt neben der Quelle in src/domain/evaluator/, nicht mit den Tests verschoben.
