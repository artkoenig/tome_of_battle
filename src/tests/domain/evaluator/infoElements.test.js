...
import { InfoElementKind, InfoLinkKind, DiagnosticKind } from '../../../domain/evaluator/model.js';
...
describe('catalogReader: Info-Elemente strukturell lesen', () => {
  it('liest profile mit typeId und characteristics in entry.infos', () => {
    ...
    expect(profile).toEqual({
      ...
      // Quellenangabe, Modifikatoren und Modifikatorgruppen (Catalogue.xsd:144-155).
      isHidden: false,
      publicationId: null,
      page: null,
      modifiers: [],
