...
import { importRosterFromXml, exportRosterToXml } from '../../../domain/roster/rosterSerialization.js';
import {
...
// End-to-end round-trips against the REAL WHFB6 catalogues (src/shared/__fixtures__/whfb6)
...
function buildSystem(catFile) {
  ...
  // System-Objekt, Shape aus src/data/db/systemImport.js).
  system.rawXmls = {
...
function importFixture(system, fixture) {
  const ros = fs.readFileSync(path.join('src/domain/roster/__fixtures__', fixture), 'utf8');
