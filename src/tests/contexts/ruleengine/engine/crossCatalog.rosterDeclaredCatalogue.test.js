 ...
 * (`prepareDataset`/`evaluate` aus `../../../contexts/ruleengine/evaluator.js`), im Muster von
 ...
 * `src/shared/rostermodel/types.js` (`Force.catalogueId`) fuehrt. Die `.ros`-Struktur selbst ist
