/**
 * Issue 0133, Review-Runde 1/2 — ein `sortIndex` ohne eigene Grenzen loest in
...
function catalogXml({ groupConstraintsXml = '', groupSortIndexAttr = '' }) {
  return `<?xml version="1.0" encoding="utf-8"?>
    <catalogue id="cat-0133-anchor" name="SortIndex Group Anchor Catalogue">
...
describe('Ein sortIndex ohne eigene Grenzen zaehlt die Gruppe nicht mit (Issue 0133)', () => {
