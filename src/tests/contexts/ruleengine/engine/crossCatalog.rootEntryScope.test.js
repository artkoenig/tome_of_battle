 ...
 * (`evaluate`/`prepareDataset` from `../../../contexts/ruleengine/evaluator.js`), following the same
...
describe('Issue 0098 Kriterium 1: Wurzel-Eintraege/-Forces gehoeren nur zum Angebot ihres eigenen Katalogs', () => {
  ...
  // (`src/contexts/ruleengine/engine/offer.js`) fragen fuer eine Kontingent-Instanz ausschliesslich
