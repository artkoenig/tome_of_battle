...
import { evaluate, prepareDataset, MeasuredPhase } from '../../../../contexts/ruleengine/evaluator.js';
...
vi.mock('../../../../contexts/ruleengine/engine/evalTree.js', async importOriginal => {
...
vi.mock('../../../../contexts/ruleengine/engine/fixpoint.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../../contexts/ruleengine/engine/countIndex.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
    buildIndex(...args) {
...
vi.mock('../../../../contexts/ruleengine/engine/offer.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../../contexts/ruleengine/engine/effectiveState.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../../contexts/ruleengine/engine/constraints.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../../contexts/ruleengine/engine/budget.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
...
vi.mock('../../../../contexts/ruleengine/engine/report.js', async importOriginal => {
  const actual = await importOriginal();
  return {
    ...actual,
    buildReport(...args) {
