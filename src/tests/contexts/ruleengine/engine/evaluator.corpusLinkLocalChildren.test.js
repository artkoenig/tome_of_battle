 ...
 * from the raw XML of BOTH corpora — `src/contexts/ruleengine/engine/__fixtures__/whfb6-definitive`
...
import { evaluate as evaluateDataset, prepareDataset, DiagnosticKind } from '../../../../contexts/ruleengine/evaluator.js';
...
const CORPORA = [
  { name: 'whfb6-definitive', dir: join(process.cwd(), 'src/contexts/ruleengine/engine/__fixtures__/whfb6-definitive') },
