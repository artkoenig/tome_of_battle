...
import {
  ...
  REVISION_STATE,
  refreshSystems,
} from '../../../../contexts/catalog/application/catalogRevisions';
import * as catalogUpdate from '../../../../platform/persistence/catalogUpdate';
import * as migrations from '../../../../platform/persistence/migrations';
...
vi.mock('../../../../platform/persistence/migrations', () => ({ runSystemMigrations: vi.fn() }));
