...
import * as database from '../../../../platform/persistence/database';
import * as systemImport from '../../../../platform/persistence/systemImport';
import * as catalogSourceIndex from '../../../../platform/persistence/catalogSourceIndex';
import * as catalogUpdate from '../../../../platform/persistence/catalogUpdate';
import * as zipExtractor from '../../../../platform/battlescribe/zipExtractor';
...
vi.mock('../../../../platform/persistence/catalogSourceIndex', () => ({ loadAvailableSystemsFromSources: vi.fn() }));
vi.mock('../../../../platform/persistence/catalogUpdate', () => ({ fetchCatalogText: vi.fn() }));
vi.mock('../../../../platform/battlescribe/zipExtractor', () => ({ extractZipFiles: vi.fn() }));
