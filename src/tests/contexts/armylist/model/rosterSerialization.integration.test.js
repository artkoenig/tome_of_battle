...
import { importRosterFromXml, exportRosterToXml } from '../../../../contexts/armylist/model/rosterSerialization.js';
import {
  reconcileImportedSelectionIds,
  syncRosterSelectionsWithSystem,
  resolveEntry
} from '../../../../contexts/armylist/model/index.js';
...
function buildSystem(catFile) {
  ...
  // System-Objekt, Shape aus src/platform/persistence/systemImport.js).
  system.rawXmls = {
...
function importFixture(system, fixture) {
  const ros = fs.readFileSync(path.join('src/contexts/armylist/model/__fixtures__', fixture), 'utf8');
