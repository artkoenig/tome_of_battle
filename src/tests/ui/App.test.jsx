...
vi.mock('../../ui/components/RosterEditor', () => ({
  default: (props) => {
    editorProps.current = props;
    return <div data-testid="editor-mock">{props.roster?.name}</div>;
  },
}));
vi.mock('../../ui/components/PlayMode', () => ({ default: ({ roster }) => <div data-testid="playmode-mock">{roster?.name}</div> }));
vi.mock('../../ui/components/editor/NewRosterModal', () => ({ default: () => <div data-testid="new-roster-modal-mock">New Roster Modal Mock</div> }));
