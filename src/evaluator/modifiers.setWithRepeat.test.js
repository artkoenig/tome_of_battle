 ...
 * (`src/__fixtures__/whfb6/`), damit der Test dieselbe Konstruktion sieht, ueber
...
const GST = 'src/__fixtures__/whfb6/Warhammer Fantasy Battle 6th edition.gst';
const CAT = 'src/__fixtures__/whfb6/Ogre Kingdoms.cat';
