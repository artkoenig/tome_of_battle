...
End-to-End-Tests der Reinraum-Engine (`src/contexts/ruleengine/engine/`). Anders als die
...
- Quelle: `artkoenig/Warhammer-Fantasy-Battles-6th-Definitive-edition`, Branch
  ...
  `CATALOG_REPO_RAW_BASE_URL` (`src/platform/persistence/catalogUpdate.js`) bezieht.
