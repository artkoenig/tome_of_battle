 ...
 *
 * Dies ist die **einzige** legale Aussenschnittstelle des `src/contexts/ruleengine/engine/`-
 * Moduls. Der Zugriff von aussen nur ueber diese Datei und die harte
 * Import-Trennung zum App-Schreibmodell `src/contexts/armylist/model/` (in beide Richtungen)
...
import { PreparedDataset } from './engine/datasetPreparation.js';
import { buildDatasetDescription, costTypesOf } from './engine/datasetDescription.js';
import { buildEvalTree, synthesizeOfferedSharedMandatoryPhantoms } from './engine/evalTree.js';
import { attachOfferAnchors } from './engine/offer.js';
import { extendBaseEffectiveState } from './engine/effectiveState.js';
import { buildIndex } from './engine/countIndex.js';
import { evaluateToFixpoint, applyAnchorPostPass } from './engine/fixpoint.js';
import { evaluateConstraints, categoryAnchorOccupancies } from './engine/constraints.js';
import { evaluateRosterBudget } from './engine/budget.js';
import { buildReport } from './engine/report.js';
import { buildRaiseCostProjection } from './engine/costProjection.js';
import { createRosterBudget } from './engine/rosterBudget.js';
import { MeasuredPhase, measurementFor } from './engine/measurement.js';
 ...
 * (Issue 0138).
 */
export { MeasuredPhase } from './engine/measurement.js';
 ...
 */
export { DiagnosticKind } from './engine/model.js';
 ...
 */
export { prepareDataset } from './engine/datasetPreparation.js';

/**
 * Wertet ein Roster gegen einen **aufbereiteten** Datensatz aus und liefert den
 * Bericht.
 *
 * @param {import('./engine/datasetPreparation.js').PreparedDataset} prepared
 ...
 * @returns {{ violations: object[], capabilities: Map<string, object>, costTotals: Record<string, number>, diagnostics: object[], measurement?: import('./engine/measurement.js').EvaluationMeasurement }}
