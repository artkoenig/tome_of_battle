import { getAllRosters, getRoster, saveRoster as persistRoster, deleteRoster as removeRoster } from '../ports/storagePort';
 ...
 *
 * Die Oberfläche erreicht Roster ausschließlich hierüber; `src/platform/persistence/database.js`
