/**
 * Issue 0133, Kriterien 1-2 — der XML-Leser (`catalogReader.js`) liest das
...
describe('parseCatalogue: sortIndex an selectionEntry (Issue 0133, Kriterium 1)', () => {
...
describe('parseCatalogue: sortIndex an selectionEntryGroup (Issue 0133, Kriterium 1)', () => {
...
describe('parseCatalogue: sortIndex an entryLink (Issue 0133, Kriterium 1)', () => {
