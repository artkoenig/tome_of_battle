 ...
 * mehr ab.
 *
 * Die Quelle ist allein die **Info-Projektion des Slots**
 * (`capability.infoElements`, ADR-0034) samt seiner eigenen Buchquelle
 * (`capability.source`). Der frueher hier haengende Namensvergleich — der Name
 * der Aufwertung gegen die geteilten Regeln des Spielsystems und aller
 * Kataloge, notfalls per Teilstring — ist ersatzlos entfallen: er verwechselte zwei
 * gleichnamige Regeln aus verschiedenen Katalogen, waehrend der Bericht die Regel
 * am Slot verankert und damit weiss, welche gemeint ist.
 */
