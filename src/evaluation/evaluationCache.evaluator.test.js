 ...
 * (`src/evaluation/evaluationCache.js`, existiert noch nicht; test-first).
 *
 * Intention:
 ...
 * `src/evaluation/useEvaluation.test.js` (Fassade als zählender
...
vi.mock('../evaluator/evaluator.js', async (importOriginal) => {
...
import { evaluateAppRoster, describeSystem } from './evaluationCache.js';
