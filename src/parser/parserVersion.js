 ...
 * Katalog-Update). Die Start-Migration (`src/db/migrations.js`) parst ein
 ...
 * Auswertungs-Cache (`src/evaluation/evaluationCache.js`).
 *
 * **Erhoehen**, sobald `src/parser/` etwas anderes aus derselben XML macht —
