...
import { syncRosterSelectionsWithSystem, calculateRosterCosts } from '../solver/validator';
...
describe('useRoster Hook', () => {
  ...
  it('initializes with the roster and its derived costs and evaluator result', () => {
  ...
  it('derives costs from the roster without waiting for the debounce', () => {
    vi.useFakeTimers();
    ...
    // Ohne Vorlauf der Debounce: die Anzeige gehört bereits zum neuen Roster
