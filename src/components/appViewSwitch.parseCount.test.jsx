 ...
 *
 * `src/db/migrations.js` laeuft hier **echt** — nur die IndexedDB und die
...
vi.mock('../parser/xmlParser', async (importOriginal) => {
...
vi.mock('./RosterEditor', () => ({ default: () => <div data-testid="editor-mock" /> }));
vi.mock('./PlayMode', () => ({ default: () => <div data-testid="playmode-mock" /> }));
vi.mock('./editor/NewRosterModal', () => ({ default: () => <div data-testid="new-roster-modal-mock" /> }));
vi.mock('./RosterDashboard', () => ({
