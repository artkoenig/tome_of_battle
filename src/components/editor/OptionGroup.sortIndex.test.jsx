/**
 * Issue 0130, Kriterium 5 — in `OptionGroup.jsx` ersetzt `sortIndex` die
...
describe('OptionGroup: sortIndex ersetzt die Kostensortierung für getaggte Optionen (Issue 0130, Kriterium 5)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
