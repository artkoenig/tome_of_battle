 ...
 * (`src/i18n/violationMessages.js`); die severity bestimmt die Optik
 ...
 *   Bericht der Evaluator-Fassade (`src/evaluator/evaluator.js`).
 ...
 * erwarteten Sätze stammen aus `src/i18n/locales/de.json`
 ...
 * in `src/i18n/violationMessages.test.js`).
 */
