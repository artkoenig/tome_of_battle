...
- After any UI-visible change, take a Puppeteer screenshot of the affected view (before/after or just the result) and send it to the user as confirmation — don't just describe the change in words.
