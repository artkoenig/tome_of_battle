/**
 * Messverfahren fuer die Reinraum-Engine (`src/contexts/ruleengine/engine/`) — **kein
 * Produktivcode**.
 *
...
import { prepareDataset, evaluate, MeasuredPhase } from '../../src/contexts/ruleengine/evaluator.js';
