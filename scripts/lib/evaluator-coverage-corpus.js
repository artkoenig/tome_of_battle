 ...
 * `src/contexts/ruleengine/engine/` (ADR 0030, ADR 0033).
 *
...
export const WHFB6_DEFINITIVE_DIR = resolve(REPO_ROOT, 'src', 'contexts', 'ruleengine', 'engine', '__fixtures__', 'whfb6-definitive');
