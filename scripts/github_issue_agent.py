...
async def main():
    ...
    if event_name == "issue_comment":
        ...
        comment_res = await analyze_comment(issue.title, issue.body, comment_body, comment_author, comments)
        ...
        # If intent was 'none', fall through to re-analysis
    ...
    if event_name == "issues" or comment_analysis == "none":
        ...
        comments = [c.body for c in issue.get_comments()]
        analysis = await analyze_issue(issue.title, issue.body, comments)
