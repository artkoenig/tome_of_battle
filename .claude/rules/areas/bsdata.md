...
Agent liest sie, bevor er formatnahen Code oder Katalogdaten anfasst — auch Subagenten. Die Datei
selbst ist nur der Index; die Kapitel stehen unter `docs/battlescribe/` (`overview.md`, `files/`,
`building-blocks/`, `patterns/`, `reference/`) und behalten die Paragraphennummern, unter denen
der Rest des Repos sie zitiert.
...
- `docs/bsdata-catalogue-development-wiki/` ist ein **Submodul** des BSData-Wikis und damit die
  ...
  ziehen mit `--remote`.
- §15 „Lücken der Quelle" (`docs/battlescribe/reference/source-gaps.md`) zählt auf, wo das Wiki schweigt. Dort entscheidet das Projekt selbst —
