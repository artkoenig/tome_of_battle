...
`scenario.json` ist das Manifest, das der Runner (`src/contexts/ruleengine/engine/e2e.testcatalog.test.js`)
...
- Ausgefuehrt wird das alles von `forge-test --run src/contexts/ruleengine/engine`; ein geaendertes Manifest
